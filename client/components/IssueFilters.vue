...
<template>
  <div class="flex flex-wrap items-center gap-x-1.5 gap-y-2">
    <!-- Separate buttons rather than a joined group: fused segments read as
         one wide control and made the row look like an unbroken bar, which is
         also how it ran into the facet chips beside it. -->
    ...
    <span v-if="groups.length" class="mx-1.5 h-4 w-px bg-default" aria-hidden="true" />
